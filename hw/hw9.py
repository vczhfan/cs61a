...
if __name__ == '__main__':
    ...
    # run_docstring_examples(adjoin_set2, globals(), True)
    # run_docstring_examples(union_set2, globals(), True)
    # run_docstring_examples(depth, globals(), True)
    # run_docstring_examples(depth, globals(), True)
    # run_docstring_examples(tree_to_ordered_sequence, globals(), True)
    run_docstring_examples(partial_tree, globals(), True)
